...
(5, Null, N'Available', '2024-03-06 16:45:00');
GO
...
SELECT * FROM Payments WHERE CustomerID = 2;
EXEC sp_helprotect @name = 'Customers';

-- Test sp_DeleteCustomer 
EXEC sp_DeleteCustomer 2;
GO
...
DROP TRIGGER IF EXISTS rg_LogDeletedCustomer;
GO
CREATE TRIGGER trg_PreventRoomDelete
ON Rooms
INSTEAD OF DELETE
AS
BEGIN
